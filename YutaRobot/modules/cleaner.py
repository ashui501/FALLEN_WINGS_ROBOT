...
from YutaRobot import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from YutaRobot.modules.sql import cleaner_sql as sql
...
CLEAN_BLUE_TEXT_HANDLER = MessageHandler(
    Filters.command & Filters.chat_type.group, clean_blue_text_must_click, run_async=True
)
