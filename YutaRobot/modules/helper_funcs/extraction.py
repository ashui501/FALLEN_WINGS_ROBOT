...
def extract_user(message: Message, args: List[str], send_messages: bool = True) -> Optional[int]:
    return extract_user_and_text(message, args, send_messages)[0]


def extract_user_and_text(
    message: Message, args: List[str], send_messages: bool = True,
