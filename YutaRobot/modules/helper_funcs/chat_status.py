...
from telegram import Chat, ChatMember, ParseMode, Update, InlineKeyboardButton, InlineKeyboardMarkup
...
def can_pin(func):
    ...
    def pin_rights(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if update_chat_title == message_chat_title:
            ...
            cant_pin = f"I can't pin messages in <b>{html.escape(update_chat_title)}</b>!\nMake sure I'm admin and can pin messages there."
...
def can_promote(func):
    ...
    def promote_rights(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if update_chat_title == message_chat_title:
            ...
            cant_promote = (
                f"I can't promote/demote people in <b>{html.escape(update_chat_title)}</b>!\n"
...
def can_restrict(func):
    ...
    def restrict_rights(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if update_chat_title == message_chat_title:
            ...
            cant_restrict = f"I can't restrict people in <b>{html.escape(update_chat_title)}</b>!\nMake sure I'm admin there and can restrict users."
...
from YutaRobot.modules import connection
connected = connection.connected

from YutaRobot.modules.helper_funcs import anonymous
