...
if ENV:
    ...
    ARQ_API_URL = os.environ.get("ARQ_API_URL", "NWQHDH-XFBBNV-POTGBM-HYXVJC-ARQ")
    ARQ_API_KEY = os.environ.get("ARQ_API_KEY", "NWQHDH-XFBBNV-POTGBM-HYXVJC-ARQ")
    KUKI_API = os.environ.get("KUKI_API", None)
    API_ID = os.environ.get("API_ID", None)
    API_HASH = os.environ.get("API_HASH", None)
    BOT_ID = int(os.environ.get("BOT_ID", "5420641611"))
